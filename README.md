...
<div>
  ...
  <b>В браузере Chrome локальный кэш DNS . доступен по ссылке chrome://net-internals/#dns</b>
...
<details>
  <summary>15. Что такое сервис-воркер (service worker)? </summary>
<div>
...
<details>
  <summary>20. Что такое Веб-компоненты и какие технологии в них используются?</summary>
  <div>
    <br/>
    <p>
