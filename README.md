...
<details>
<summary>37. Что такое React.lazy(), suspense?</summary>
<div>
...
<details>
<summary>38. React 18 в кратце об изменениях?</summary>
<div>
...
<div>
  ...
  <p>
   ...
   <p>Метод dispatch позволит передать инструкцию для Store, что мы хотим изменить дерево состояния. Это обрабатывается с помощью только что рассмотренного редюсера.</p>
   ...
   <h3>Store.value()</h3>
   <p>Свойство value создают как геттер и будет возвращать внутреннее дерево состояния (так мы сможем обращаться к свойством)</p>
