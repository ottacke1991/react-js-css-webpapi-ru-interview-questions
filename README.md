...
<details>
<summary>15. За что отвечает свойство will-change?</summary>
<br>
<div>
CSS свойство will-change предоставляет автору возможность уведомить браузер об ожидаемом изменении элемента, таким образом браузер может настроить соответствующую оптимизацию до того как элемент действительно изменится. Такой тип оптимизации может повысить отзывчивость страницы, совершая, возможно дорогие операции до того как они действительно понадобятся. </div>  
</details>  
...
<details>
  <summary>21. В чем отличие Promise.all от Promise.allSettled</summary>
  <div>
    Отличие Promise.all от Promise.allSettled в том, что Promise.allSettled вернет результат выполнения каждого Promise, не важно в каком состоянии (исполнены или отклонены), а Promise.all будет выполнен когда будут выполнены все промисы или отклонён, если будет отклонено хоть одно из переданных промисов.
  </div>
</details>
...
<details>
  <summary>20. Расскажите как браузер рендерит страницу</summary>
  <div>
    <br/>
