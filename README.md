...
<details>
<summary>Что такое препроцессор и зачем он нужен?</summary>
<div>
  ...
  <p>При помощи препроцессоров вы можете писать код, который нацелен на:</p>

  <h3>Читабельность для человека</h3>
  <h3>Структурированность и логичность</h3>
  <h3>Производительность    </h3>
</div>  
</details>  

<details>
<summary>Что такое Mixins, переменные и вложенность в препроцессорах?</summary>
<h2>Mixins</h2>
<div>
...
<details>
<summary>Расскажите про блочные и строчные элементы?</summary>
<div>
<h2>Блочные</h2>
...
<details>
<summary>Расскажите про float?</summary>
<div>
...
<br />
<p>Чтобы предотвратить обтекание, нужно для этих элементов установить свойство **_clear_**  как **_right_** или **_left_** (не позволяет элементу обтекать другие с правой или с левой стороны) или **_both_**  (с обеих сторон).  
По умолчанию все элементы будут обтекать _float_-ы, свойство clear имеет значение по умолчанию clear: none;_ - отключено. </p>
<br /> 
...
<p>Использование метода clearfix. Для этого у элемента, после которого требуется очистка, указывается правило clear: both в псевдоэлементе after.</p>

<p>Свойство overflow со значением hidden. Само по себе свойство overflow управляет отображением содержимого блока (добавляет полосы прокрутки, обрезает не поместившийся контент), в добавок, значения auto, scroll или hidden отменяют свойство float.</p>
...
<details>
<summary>Область видимости переменной?</summary>
<div>
...
<details>
<summary>var VS let VS const?</summary>
<div>
...
<details>
<summary>Что такое NaN? Какого типа это значение? Как можно узнать, равно ли значение переменной NaN?</summary>
...
<details>
<summary>В чем разница между undefined и is not defined?</summary>
...
<details>
<summary>Опишите разницу между == и === в JS ?</summary>
...
<details>
<summary>Что делает строчка “use strict”;? Какие достоинства и недостатки от ее использования?</summary>
<div>
  <p>
...
<details>
<summary>Что такое запоминание или мемоизация (Memoization)?</summary>
<div>
...
<details>
<summary>Композиция в реакт?</summary>
<div>
...
<details>
<summary>Согласование в React?</summary>
<div>
...
<details>
<summary>Что такое state в React?</summary>
<div>
  <br />
  <p>
...
<details>
<summary>События в React?</summary>
<div>
  <br />
  <p>
...
<details>
<summary>Хук useCallback?</summary>
<div>
  <p>
...
<details>
  <summary>Методы REST API ?</summary>
  <div>
...
<details>
  <summary>Объясните, что такое всплытие и погружение (event bubbling)</summary>
  <div>
